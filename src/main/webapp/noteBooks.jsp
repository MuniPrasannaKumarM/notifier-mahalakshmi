...
<body>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-1 text-left"><b>
										<a id="editNoteBook" href="editNoteBook?itemId=<c:out value='${notebook.id}' />"><c:out value="${notebook.noteBookName}" />
										</a></b>
										<div>
									      <c:out value="${notebook.value} Notes" />
									   </div>
									</div>
									<div class="col-md-10 text-right">
										<a data-toggle="modal" data-target="#renameNoteBookModal" data-id = "${notebook.id}" class="open-AddBookDialog" href="#addBookDialog"><span
											class="glyphicon glyphicon-edit">Rename</span></a>
									</div>
									
									<div>
										<a id="deleteNoteBook"  href="deleteNoteBook?itemId=<c:out value='${notebook.id}' />"><span
	...
	<div id="renameNoteBookModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg" role="content">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="renameNoteBook" method = "post">
                     <div class="form-group row">
                          <label for="notebook_id" class="col-md-2 col-form-label">NoteBook ID:</label>
                           <div class="col-12 col-md-8 ">
                              <input type="text" class = "form-control" name="notebook_id" id="notebook_id" value=""/>
						    </div>
                       </div>
                        <div class="form-group row">
                            <label for="noteBookName" class="col-md-2 col-form-label">Name:</label>
                            <div class="col-12 col-md-8 ">
                                <input type = "text" class="form-control" id = "noteBookName" name = "noteBookName"  placeholder="NoteBook Name">
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-0">
                            ...
                            <div class="col-xs-2">
                                <button type = "submit" class="btn btn-primary btn-block" href = "#">Submit</button>
                            </div>  
                        </div>
                        <div class="form-group row">
  ...
  //          return flag;
    //    }
        ...
        $(document).on("click", ".open-AddBookDialog", function () {
            ...
            $(".modal-body #notebook_id").val( myBookId );
