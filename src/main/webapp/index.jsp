			...
			<form action="login"  method="post"  onsubmit="return validateUser()">
				<table cellspacing="2">
					<tr>
				     ...
				     <tr>
						<td><div id="error" style="color: red; display: block"><c:out value="${error}" /></div></td>
					</tr>
					<tr>
						<td><div id="message" style="color: red; display: block"><c:out value="${message}" /></div></td>
					</tr>
					...
					<center>
					<tr>
						<td><br><center>Not a member?<a href="signup.jsp
						">Sign Up</a></center></td>
					</tr>
					</center>
				</table>
