...
<c:forEach items="${noteObjDate}" var="note"> 
			<h3><a id="dailyTask"
				 href="showNoteDetailsNote?itemId=${note.id}">${note.noteName}</a></h3>
			<p>StartDate :${note.startDate}</p>
			<p>EndDate   : ${note.endDate} </p>
		...
		<% i=i+1; %>
			<tr>
				...
				data-target="#editModal" style="visibility: ${ui}" class="Maha"><span
										...
										<div>
											<a href="deleteNotes?itemId=${item.id}"><span
	...
	<div class="modal fade" id="editModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
					...
					<form action="editNotes" method="post" onsubmit="return validateNoteForm()">
